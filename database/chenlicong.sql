...
CREATE TABLE `clc_article_categorys` (
  ...
  `is_visible` tinyint(4) unsigned DEFAULT '1',
...
-- ----------------------------
-- Table structure for `clc_likes`
-- ----------------------------
DROP TABLE IF EXISTS `clc_likes`;
CREATE TABLE `clc_likes` (
